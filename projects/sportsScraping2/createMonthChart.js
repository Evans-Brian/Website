function createMonthPercentChart(year){
	var data;
	$.getJSON("monthCounts.json", function(json){
	    data = json;
  year = '2018'
  console.log(data)
  ...
  var month = new Array();
	...
	data.forEach(function(d, i) {
	  ...
	  d.values.forEach(function(d) {
			console.log(d.date.substring(0,4))
			if (d.date.substring(0,4)=='2012'){
		    d.id = i;
	...
	var yScale = d3.scaleLinear()
	  .domain([0, d3.max(data[0].values, d => d.percent*3)])
